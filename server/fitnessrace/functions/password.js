...
exports.updateUser = (email, newName, newAge, newCity) =>
	...
	new Promise((resolve, reject) => {
		...
		user.find({ email: email })
			...
			.then(user => resolve({ status: 200, message: 'User Data Updated Sucessfully !' }))

			.catch(err => reject({ status: 500, message: 'Internal Server Error !' }));

	});

	exports.updateUsersAR = (email, rewards, achievements) =>
