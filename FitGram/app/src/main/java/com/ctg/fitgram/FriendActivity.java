...
public void findFriendFunction(View view)
{
    Intent intent = new Intent(this, FriendFindingActivity.class);
    ...
    public void myFriendFunction()
    {
        ...
        Call<Response> call = retrofitInterface. friendList(mEmail);
        //
